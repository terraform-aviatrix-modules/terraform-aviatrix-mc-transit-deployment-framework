variable "transit_firenet" {
  type = map(object({
    ...
    transit_bgp_lan_interfaces               = optional(list(map(string))),
    ...
    transit_availability_domain              = optional(string),
    transit_ha_availability_domain           = optional(string),
    transit_fault_domain                     = optional(string),
    transit_ha_fault_domain                  = optional(string),
    transit_enable_preserve_as_path          = optional(bool),
    transit_enable_gateway_load_balancer     = optional(bool),
    transit_bgp_lan_interfaces_count         = optional(number),
